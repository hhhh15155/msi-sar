...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train FreKFuse and print test metrics.")
    parser.add_argument("--config", default="configs/frekfuse_yrd_fs5.yaml")
    args = parser.parse_args()

    from baselines.frekfuse.eval import save_labeled_maps
    from baselines.frekfuse.train import run_training
    ...
    if run_config_path.exists():
        from baselines.frekfuse.io import load_yaml
